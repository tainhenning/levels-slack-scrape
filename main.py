...
def main():
    ...
    recent_salary = driver.find_element_by_xpath(
        fyi_links[constants.RECENT_SALARY_XPATH]
    )
    recent_yoe = driver.find_element_by_xpath(fyi_links[constants.RECENT_YOE_XPATH])
    recent_level_name = driver.find_element_by_xpath(
        fyi_links[constants.RECENT_LEVEL_NAME_XPATH]
    )
